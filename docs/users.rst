...
* **Remove** a role by clicking the selected checkbox, or in the Actions column, clicking the |remove-all| button will remove all the user's roles at that organisation.
