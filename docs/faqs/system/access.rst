...
#. For existing profile updates, list the email being changed, what is was and what it should be changed to
...
By ensuring you enter the same email when completing the invitation steps in
:ref:`adding-an-existing-user`, the system will automatically pick up if a user
already exists in the PMHC MDS and will grant them access to the additional
organisation.
...
You can :ref:`reissue-invite`. When you reissue an invitation, the email is sent again to the invitee.
...
If your name or email address has changed, it is important that you update
...
will email the registered email address on your account.

See :ref:`forgotten-password` for instructions on resetting your password.

It is important to keep your email address current so that you can make use of
this facility. If you can no longer access the PMHC MDS please email the PMHC MDS
Helpdesk at support@pmhc-mds.com to update your email address.
